...
<div style="margin: 2rem 0; border: 1px solid #1e293b; border-radius: 12px; overflow: hidden; background: #0b101b; box-shadow: 0 10px 40px rgba(0,0,0,0.6);">
  <img src="{{ '/assets/images/lms-education-architecture.jpg' | relative_url }}" alt="RobOS LMS and eLearning Engine Architecture" class="robos-zoomable-img" style="display: block; width: 100%; height: auto;" />
  <div style="padding: 0.75rem 1.25rem; font-size: 0.85rem; color: #94a3b8; border-top: 1px solid #1e293b; background: #0d1424; text-align: center;">
    <strong>RobOS Learning Management System Architecture</strong>: AI course synthesis from repository history, interactive player with quizzes, practice lab launching, and team audit reporting. <em>(Click image to zoom full screen)</em>
  </div>
</div>
