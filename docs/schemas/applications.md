...
| [**Front End App** (`robos:FrontEndApp`)]({{ '/schemas/applications/front-end-app.html' | relative_url }}) | `urn:robos:shape:FrontEndAppShape` | `dcterms:title`, `robos:repository`, `robos:technology`, `robos:frontendFramework`, `robos:appTemplate`, `robos:hostingPlatform`, `robos:productionUrl`, `robos:databaseEngine`, `robos:authStrategy`, `robos:abuseControls`, `robos:captchaProvider`, `robos:crawlerPolicy`, `robos:sitemapUrl`, `robos:llmsTxtUrl`, `robos:structuredData`, `robos:e2eEvidence` | [View Schema &rarr;]({{ '/schemas/applications/front-end-app.html' | relative_url }}) |
