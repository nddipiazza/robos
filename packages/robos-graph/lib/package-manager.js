...
class KGraphPackageManager {
  ...
  inferPackageForNode(node) {
    ...
    if (typeStr.includes('Gherkin') || typeStr.includes('Scenario') || typeStr.includes('InfinityAIDirective') || typeStr.includes('CRPGPlayerInput') || typeStr.includes('CRPGCombatant') || typeStr.includes('CRPGBattleMap') || typeStr.includes('CRPGMapObject') || typeStr.includes('ScenarioStep') || typeStr.includes('ScenarioOutline') || typeStr.includes('ExamplesTable') || typeStr.includes('StepDefinition') || typeStr.includes('DataTable') || typeStr.includes('DocString') || typeStr.includes('TestPlan') || typeStr.includes('TestCase') || typeStr.includes('TestExecution') || typeStr.includes('TestExecutionRecord') || typeStr.includes('TestSuite') || typeStr.includes('TestingLibrary') || typeStr.includes('TestFramework') || typeStr.includes('BDDFeature')) {
      return 'testing';
    }
    if (typeStr.includes('Documentation') || typeStr.includes('SystemDocumentation') || typeStr.includes('FlowDiagram') || typeStr.includes('DocumentationPage') || typeStr.includes('DocArticle') || typeStr.includes('DocSection') || typeStr.includes('ArchitectureDecisionRecord') || typeStr.includes('ADR') || typeStr.includes('ADROption') || typeStr.includes('InteractiveWalkthrough') || typeStr.includes('CodeSnippet') || typeStr.includes('CodeSample') || typeStr.includes('ApiGuide')) {
      return 'documentation';
    }
    if (typeStr.includes('Person') || typeStr.includes('Developer') || typeStr.includes('Team') || typeStr.includes('GitProjectOrganization') || typeStr.includes('GitOrganization') || typeStr.includes('GitRepository') || typeStr.includes('GitBranch') || typeStr.includes('PullRequest') || typeStr.includes('MergeRequest') || typeStr.includes('GitCommit') || typeStr.includes('CommitRef') || typeStr.includes('GitTag') || typeStr.includes('Company') || typeStr.includes('AgentPersona') || typeStr.includes('AIAgent') || typeStr.includes('TaskServer') || typeStr.includes('Project') || typeStr.includes('Milestone') || typeStr.includes('Sprint') || typeStr.includes('Epic') || (typeStr.includes('UserStory') && !typeStr.includes('Gherkin')) || (typeStr.includes('Story') && !typeStr.includes('Gherkin')) || typeStr.includes('Task') || typeStr.includes('Subtask') || typeStr.includes('Bug') || typeStr.includes('Defect') || typeStr.includes('ChangeRequest') || typeStr.includes('CommunicationChannel') || typeStr.includes('Comment') || typeStr.includes('Discussion') || typeStr.includes('Attachment') || typeStr.includes('Conversation')) {
      return 'organization';
    }
