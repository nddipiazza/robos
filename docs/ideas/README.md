...
| **RobOS Kgraph Parse Portal** (supersedes KGraph Crawler) | [raw note](inbox/robos-kgraph-crawler.txt) | [feature spec](specs/robos-kgraph-crawler.md) | Implemented ([Docs](../kgraph-parse-portal.html)) | `packages/kgraph-parse-portal`, `packages/robos-graph`, Luxir Index, Hermetiq Buildbarn Helm RBE (`oci://ghcr.io/hermetiq/buildbarn`), Apache Tika 4.0 `tika-grpc` |
