...
|---|---|---|---|---|
| **`dcterms:title`** | Title / Display Name | `1..*` | `xsd:string` | Consumer Group must have a title. |
| **`robos:groupId`** | Consumer Group ID | `1..*` | `xsd:string` | Consumer Group must declare consumer group ID. |
| **`robos:topic`** | Knowledge Domain Topic | `1..*` | `xsd:string` | Consumer Group must link to subscribed topic. |
