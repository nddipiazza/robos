...
| [**Search Cluster** (`robos:SearchCluster`)]({{ '/schemas/core-platform/search-cluster.html' | relative_url }}) | `urn:robos:shape:SearchClusterShape` | `dcterms:title`, `robos:engine` | [View Schema &rarr;]({{ '/schemas/core-platform/search-cluster.html' | relative_url }}) |
...
| [**MCP Tool** (`robos:MCPTool`)]({{ '/schemas/core-platform/mcp-tool.html' | relative_url }}) | `urn:robos:shape:MCPToolShape` | `dcterms:title`, `robos:toolName`, `robos:mcpServer`, `robos:inputSchema`, `robos:outputSchema`, `robos:annotations`, `robos:toolAnnotations`, `robos:parameters` | [View Schema &rarr;]({{ '/schemas/core-platform/mcp-tool.html' | relative_url }}) |
| [**MCP Resource** (`robos:MCPResource`)]({{ '/schemas/core-platform/mcp-resource.html' | relative_url }}) | `urn:robos:shape:MCPResourceShape` | `dcterms:title`, `robos:uriTemplate`, `robos:mcpServer`, `robos:uri`, `robos:mimeType`, `robos:annotations` | [View Schema &rarr;]({{ '/schemas/core-platform/mcp-resource.html' | relative_url }}) |
| [**MCP Prompt** (`robos:MCPPrompt`)]({{ '/schemas/core-platform/mcp-prompt.html' | relative_url }}) | `urn:robos:shape:MCPPromptShape` | `dcterms:title`, `robos:promptName`, `robos:mcpServer`, `robos:arguments` | [View Schema &rarr;]({{ '/schemas/core-platform/mcp-prompt.html' | relative_url }}) |
