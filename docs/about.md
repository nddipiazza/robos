...
<div style="margin: 2rem 0; border: 1px solid #1e293b; border-radius: 12px; overflow: hidden; background: #0b101b; box-shadow: 0 10px 40px rgba(0,0,0,0.6);">
  <img src="{{ '/assets/images/robo-chrono-trigger.jpg' | relative_url }}" alt="Artistic tribute to Robo (R-66Y / Prometheus) in Fiona's lush forest" class="robos-zoomable-img" style="display: block; width: 100%; height: auto;" />
  <div style="padding: 0.75rem 1.25rem; font-size: 0.85rem; color: #94a3b8; border-top: 1px solid #1e293b; background: #0d1424; text-align: center;">
    <strong>Homage to Prometheus (R-66Y / Robo)</strong>: The selfless mechanical companion from <em>Chrono Trigger</em> who spent 400 years restoring Fiona's forest so future generations could thrive. <em>(Click image to zoom)</em>
  </div>
</div>
