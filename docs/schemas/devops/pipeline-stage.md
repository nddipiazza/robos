...
- **Agent Guidelines**: When autonomous agents generate, expand, or validate instances of `robos:PipelineStage`, they MUST adhere to and base their output on this referred schema object and universal Schema.org parent class, extending it with RobOS SDLC properties.
