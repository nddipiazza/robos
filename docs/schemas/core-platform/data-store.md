...
|---|---|---|---|---|
| **`dcterms:title`** | Title / Display Name | `1..*` | `xsd:string` | Logical data store needs a title. |
| **`robos:engine`** | engine | `1..*` | `xsd:string` | Logical data store needs its engine. |
| **`robos:evidence`** | evidence | `1..*` | `xsd:string` | Logical data store needs source evidence. |
