...
STEP_PATTERNS = [
    ...
    (r'the hero attempts to target "([^"]+)" and cast spell "([^"]+)"',
     'Spell targeting test: hero attempts to channel spell "{1}" targeting "{0}".'),
    (r'the hero attempts to attack "([^"]+)"',
     'Attack targeting test: hero attempts to execute a physical strike against target "{0}".'),
    (r'the hero attacks "([^"]+)"',
     'Attack execution: hero executes an attack strike against target "{0}".'),
    (r'the targeting fails with error containing "([^"]+)"',
     'Targeting restriction: verifying targeting rejected with message containing "{0}".'),
    (r'enemy "([^"]+)" is not visible to the player',
     'Invisibility verification: confirming enemy "{0}" is completely invisible to player (node hidden, opacity 0).'),
    (r'the hero equips item "([^"]+)"',
     'Equipment action: hero equips magical gear "{0}".'),
    (r'the hero has item "([^"]+)" equipped',
     'Equipment check: verifying item "{0}" is actively equipped in gear slot.'),
    (r'the hero can see invisible creatures',
     'True Sight check: verifying hero gains sensory divination to perceive invisible creatures.'),
    (r'enemy "([^"]+)" is revealed to the player with ethereal shimmer',
     'Divination revelation: invisible enemy "{0}" is rendered visible to player with translucent ethereal shimmer.'),
    (r'enemy "([^"]+)" is completely visible',
     'Visibility restoration: enemy "{0}" is fully visible with 100% normal opacity.'),
    (r'enemy "([^"]+)" is protected by sanctuary',
     'Ward verification: confirming enemy "{0}" is protected by divine Sanctuary ward and untargetable.'),
    (r'enemy "([^"]+)" is no longer protected by sanctuary',
     'Ward expiration: confirming Sanctuary ward has dropped from "{0}", enabling direct targeting.'),
]
