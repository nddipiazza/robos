---
name: deploy-to-vm
description: Deploy one or more packages/apps/libraries from the local repository to the running RobOS QEMU VM.
---
...
If not reachable, start the VM first (`/start-vm`).
