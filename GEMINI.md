...
This file provides guidance to Gemini (Gemini Code Assist / Gemini CLI) when working with code in this repository.
...
Custom operations available via `.gemini/commands/`:
