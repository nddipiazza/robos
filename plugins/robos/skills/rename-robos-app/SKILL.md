---
name: rename-robos-app
description: Rename a RobOS desktop application, updating its package directory, desktop entry, icon registry, and documentation.
---
...
Update the app name in the App Suite tables in `AGENTS.md`.
...
- Verify `packages/robos-icons/builtin-apps.js` has the updated entry
