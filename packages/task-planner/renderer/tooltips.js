...
const plannerTooltips={
 ...
 'planner-save':()=>plannerSession?.plan?'Save the edited implementation plan locally and clear its previous approval. Review and approve it again before implementation.':'Save this document to the local RobOS project. This does not change the GitHub issue.',
