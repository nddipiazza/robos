...
|---|---|---|---|---|
| **`dcterms:title`** | Title / Display Name | `1..*` | `xsd:string` | Gherkin Background must have a title. |
| **`robos:steps`** | Scenario Steps | `1..*` | `Array<robos:ScenarioStep>` | Gherkin Background must define prerequisite steps. |
| **`robos:inFeature`** | inFeature | `1..*` | `xsd:string` | Gherkin Background must link to parent Gherkin feature. |
