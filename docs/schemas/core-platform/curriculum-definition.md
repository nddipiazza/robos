...
|---|---|---|---|---|---|
| **`dcterms:title`** | Title / Display Name | `1..*` | `xsd:string` | Services & processing, Applications & entry points, Contracts & data models, Data stores & messaging, Libraries & build systems, Infrastructure & delivery, Organization & people, Projects & work items, Source control & artifacts, Agents & MCP, Documentation & decisions, Learning & assessment, Testing & behavior | Curriculum needs a title. |
| **`robos:sourcePath`** | sourcePath | `1..*` | `xsd:string` | Source control & artifacts, Agents & MCP, Learning & assessment | Curriculum needs its source document. |
| **`robos:evidence`** | evidence | `1..*` | `xsd:string` | Data stores & messaging, Infrastructure & delivery, Source control & artifacts, Agents & MCP, Learning & assessment | Curriculum needs source evidence. |
