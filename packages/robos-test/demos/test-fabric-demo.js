...
console.error(
  'Retired demo: test-fabric. Its canned graph-viewer panels have been removed.\n' +
  'No app was launched and no walkthrough was recorded.\n' +
  'Backend coverage: node --test packages/robos-test/tests/sdlc-graph/test-fabric.test.js\n' +
