...
|---|---|---|---|---|---|
| **`dcterms:title`** | Title / Display Name | `1..*` | `xsd:string` | Services & processing, Applications & entry points, Contracts & data models, Data stores & messaging, Libraries & build systems, Infrastructure & delivery, Organization & people, Projects & work items, Source control & artifacts, Agents & MCP, Documentation & decisions, Learning & assessment, Testing & behavior | Prompt Strategy must have a title or display name. |
| **`robos:strategyType`** | strategyType | `1..*` | `xsd:string` | Agents & MCP | Prompt Strategy must declare strategy type (compression, teleprompter-optimization, few-shot-compilation). |
| **`robos:engine`** | engine | `1..*` | `xsd:string` | Data stores & messaging, Agents & MCP | Prompt Strategy must declare optimization engine (caveman, dspy, standard). |
