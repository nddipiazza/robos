...
| # | Story | Status | Points |
|---|-------|--------|--------|
| 01 | [robos-mcp-lib — shared MCP server framework](story-01-robos-mcp-lib.md) | **Done** | 5 |
| 02 | [MCP Server Manager app — discover, configure, test](story-02-mcp-server-manager.md) | **Done** | 5 |
| 03 | [MCP Router — unified endpoint multiplexing all servers](story-03-mcp-router.md) | **Done** | 5 |
| 04 | [Task Manager MCP server](story-04-task-manager-mcp.md) | **Done** | 3 |
| 05 | [Workspace Manager MCP server](story-05-workspace-mcp.md) | **Done** | 3 |
| 06 | [EKGraph MCP server](story-06-ekgraph-mcp.md) | **Done** | 3 |
| 07 | [CI Monitor MCP server](story-07-ci-monitor-mcp.md) | **Done** | 3 |
| 08 | [IDE Bridge MCP server](story-08-ide-bridge-mcp.md) | **Done** | 3 |
| 09 | [System MCP server (prefs, notifications, search)](story-09-system-mcp.md) | **Done** | 3 |
| 10 | [Universal AI Agent auto-configuration (AGENTS.md + mcp_servers)](story-10-claude-code-autoconfig.md) | **Done** | 3 |
| 11 | [Dev Tools MCP server (install/check tools)](story-11-dev-tools-mcp.md) | **Done** | 2 |
