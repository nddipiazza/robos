import { SITE_URL, PRIVATE_PATHS } from '../lib/site.js';

// Search engines, AI search/answer engines, AI agents and link-preview bots are welcome on public
// pages; private, per-user and API routes are off limits to everyone.
// To opt out of AI *training* while staying in AI *search*, move GPTBot, ClaudeBot, CCBot,
// Google-Extended, Applebot-Extended and Meta-ExternalAgent into a rule with `disallow: '/'`.
