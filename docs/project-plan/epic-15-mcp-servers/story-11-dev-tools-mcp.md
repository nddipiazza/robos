# Story 15-11: Dev Tools MCP Server
...
Resources:
- `robos://devtools/installed` — List of currently installed tools
- `robos://devtools/available` — Full tool catalog

## Acceptance Criteria

- [ ] AI agent can check if Docker is installed and install it if not
- [ ] Install progress streamed back to agent
- [ ] Tool registry matches Dev Tools app exactly
