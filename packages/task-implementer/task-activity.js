...
function activity(urls){const result={};for(const url of (urls||[]).slice(0,200)){if(!/^https:\/\/github\.com\//.test(url))continue;core.identity(url);result[url]=progress(core.read(url));}return result;}
