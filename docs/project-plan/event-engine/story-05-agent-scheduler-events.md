...
Extends the Rule Engine (story 18-02) with agent-specific action types that allow events to trigger AI agent sessions and complex multi-step automations. This is the bridge between the Event Engine and AI Agent Integration.
