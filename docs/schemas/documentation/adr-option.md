...
|---|---|---|---|---|
| **`dcterms:title`** | Title / Display Name | `1..*` | `xsd:string` | ADR Option must have a title. |
| **`robos:adr`** | Parent ADR | `1..*` | `URI (robos:ArchitectureDecisionRecord)` | ADR Option must link to parent Architecture Decision Record. |
